...
echo 'cellranger count --id=${i} --transcriptome=/gpfs/fs1/data/covid19lab/genome/L_var_3_3 --fastqs=/data/wraycompute/alejo/singlecell/AJ/HFTGCDRXX --sample=${i} --expect-cells=3000  `star_parameters="--outFilterMatchNminOverLread 0 --outFilterMatchNminOverLread 0 --outFilterMismatchNoverLmax=0.05 --outFilterMultimapNmax 0"`' >> $i.fastq2counts.sh;
done
